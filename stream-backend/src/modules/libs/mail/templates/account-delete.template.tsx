...
export function AccountDeletionTemplate({ domain }: AccountDeletionTemplateProps) {
    ...
    return (
        <Html>
            <Head />
            <Preview>Your account has been completely deleted</Preview>
            <Tailwind>
                <Body className='max-w-2xl mx-auto p-6 bg-slate-50'>
                    <Section className="text-center">
                        ...
                        <Text className="text-base text-black mt-2">
                            Your account has been completely deleted from the
                            Stream database. All your data and information
                    ...
                    <Section className="bg-white text-black text-center rounded-lg shadow-md p-6 mb-4">
                        ...
                        <Text>
                            If you want to return to the platform, you can
                            register again using the following link:
                        </Text>
                        <Link
                            href={registerLink}
                    ...
                    <Section className="text-center text-black">
                        <Text>
                            Thank you for being with us! We will always be happy
